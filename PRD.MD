...
- `GET|POST /api/venues/[venueId]/items`, `GET|PATCH|DELETE /api/venues/[venueId]/items/[id]`, `POST .../items/reorder`, `POST .../items/bulk-visibility`
...
### Testing
- Vitest v4, 82 tests: 48 renderer, 8 auth, 26 integration
